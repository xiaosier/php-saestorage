...
define("ACCOUNT_CONTAINER_COUNT", "X-Sws-Account-Container-Count");
define("ACCOUNT_BYTES_USED", "X-Sws-Account-Bytes-Used");
define("ACCOUNT_KEY", "X-Sws-Account-Meta-Key");
define("ACCOUNT_METADATA_HEADER_PREFIX", "X-Sws-Account-Meta-");
define("CONTAINER_OBJ_COUNT", "X-Sws-Container-Object-Count");
define("CONTAINER_BYTES_USED", "X-Sws-Container-Bytes-Used");
define("CONTAINER_METADATA_HEADER_PREFIX", "X-Sws-Container-Meta-");
define("DELETE_AFTER", "X-Sws-Delete-After");
define("DELETE_AT", "X-Sws-Delete-At");
define("MANIFEST_HEADER", "X-Sws-Object-Manifest");
define("METADATA_HEADER_PREFIX", "X-Sws-Object-Meta-");
define("CONTENT_HEADER_PREFIX", "Content-");
define("ACCESS_CONTROL_HEADER_PREFIX", "Access-Control-");
define("ORIGIN_HEADER", "Origin");
define("CDN_URI", "X-Sws-CDN-URI");
define("CDN_SSL_URI", "X-Sws-CDN-SSL-URI");
define("CDN_STREAMING_URI", "X-Sws-CDN-Streaming-URI");
define("CDN_ENABLED", "X-Sws-CDN-Enabled");
define("CDN_LOG_RETENTION", "X-Sws-Log-Retention");
define("CDN_ACL_USER_AGENT", "X-Sws-User-Agent-ACL");
define("CDN_ACL_REFERRER", "X-Sws-Referrer-ACL");
...
define("CDN_EMAIL", "X-Sws-Purge-Email");
